    ...
    return (
      <View style={styles.container}>
        <Calendar
          ...
          renderCalendarCell={(rowData, sectionID, rowID) => {
            return (
            ...
            style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: rowData.day.isSame(new Date(), "day") ? 'rgba(141, 196, 61,.1)' : null , alignItems: 'center', paddingBottom: 10 }}
                  onPress={()=>{ this.setState({selectedDate : rowData.day.format("YYYY-MM-DD") }) }}
                  >
